...
class AmazonPayTest < Test::Unit::TestCase
  def setup
    @gateway = AmazonPayGateway.new(some_credential: 'login', another_credential: 'password')
  ...
  def successful_purchase_response
    %(
      ...
      $ DEBUG_ACTIVE_MERCHANT=true ruby -Itest \
        test/remote/gateways/remote_amazon_pay_test.rb \
